...
class TranslateTextAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            # source_lang=auto غير مدعوم في MyMemory، نستخدم ar كافتراضي
            ...
            return Response({'error': 'فشلت الترجمة، حاول مرة أخرى'}, status=status.HTTP_503_SERVICE_UNAVAILABLE)
        except requests.RequestException:
            return Response({'error': 'خدمة الترجمة غير متاحة حالياً'}, status=status.HTTP_503_SERVICE_UNAVAILABLE)
